export default {
  ...
  booking: {
    ...
    successMessage: 'تم حجز مقعدك. أكمل الدفع خلال 15 دقيقة لتأكيد حجزك.',
    ...
    package: 'الباقة',
    requiredField: 'مطلوب',
    paymentRedirectInfo: 'بعد الحجز، ستُحوَّل لإتمام الدفع عبر ميسر. مقعدك محجوز لمدة 15 دقيقة.',
