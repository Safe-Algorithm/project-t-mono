...
function makeStyles(c: ThemeColors) {
  return StyleSheet.create({
    ...
    outline: { backgroundColor: c.transparent, borderWidth: 1.5, borderColor: c.primary, elevation: 0, shadowOpacity: 0, shadowColor: 'transparent', shadowOffset: { width: 0, height: 0 }, shadowRadius: 0 },
    ghost: { backgroundColor: c.transparent, elevation: 0, shadowOpacity: 0, shadowColor: 'transparent', shadowOffset: { width: 0, height: 0 }, shadowRadius: 0 },
